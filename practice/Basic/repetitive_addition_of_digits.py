...
Explanation:
For example, if we consider 98, we get 9+8  = 17 after first addition. Then we get 1+7 = 8.
We stop at this point because we are left with one digit.
"""


def repetitive_addition_of_digits(n):
    return n % 9
...
if __name__ == '__main__':
    ...
    for i in range(t):
        n = int(input())
        print(repetitive_addition_of_digits(n))

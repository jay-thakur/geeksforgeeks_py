...
Ishaan also has a superpower. He can reduce the height of a wall by K by using his superpower. Since he can't use this power many times, calculate the minimum number of times he has to use this power to go over all the walls.
